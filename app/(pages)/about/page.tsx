        ...
        <div className="tablet:flex tablet:space-x-12">
          <div className="flex flex-col space-y-6 tablet:w-2/3">
            <p>
              ...
              a Bachelor of Science in Computer Science and Biology. I&apos;m
              ...
              user-friendly applications and am always looking to expand my
              software toolkit and contribute to meaningful projects.
            </p>
            <p>
              At Northeastern, I was the Editor-in-Chief of NU Sci Magazine, the
              university&apos;s student-run science magazine. Science
              communication is a huge passion of mine, and you can check out my
              writing <Hyperlink text="here!" href="/articles" /> I was also an
