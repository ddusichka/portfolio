  ...
  projects: [
    {
      ...
      coverPhotos: ["/areniusDashboard.png"],
          ...
          <div className="tablet:flex justify-between">
            <div className="flex flex-col gap-8 mr-8">
              <p>
                ...
                of two tech leads, I managed a team of 5 engineers and created
              ...
              <p>
                ...
                Xero, an accounting API, and Climatiq, a carbon accounting API
                for estimating carbon emissions based on financial transactions.
                Once the design team created Figma mockups, we built the
